	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("決定")) {
			switch (fonts.getSelectedItem()) {
				case "Serif":
					font = new Font(Font.SERIF, Font.BOLD, Integer.parseInt(fsize.getSelectedItem()));
					break;
				case "SansSerif":
					font = new Font(Font.SANS_SERIF, Font.BOLD, Integer.parseInt(fsize.getSelectedItem()));
					break;
				case "Monospaced":
					font = new Font(Font.MONOSPACED, Font.BOLD, Integer.parseInt(fsize.getSelectedItem()));
					break;
				case "Dialog":
					font = new Font(Font.DIALOG, Font.BOLD, Integer.parseInt(fsize.getSelectedItem()));
					break;
				case "DialogInput":
					font = new Font(Font.DIALOG_INPUT, Font.BOLD, Integer.parseInt(fsize.getSelectedItem()));
					break;
				default:
					break;
			}
